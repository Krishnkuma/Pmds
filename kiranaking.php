...
<body>
    ...
    <main>
        ...
        <div class="container">
            <?php
            $query="SELECT * FROM `kiranaking` ORDER BY id ASC";
            ...
            if(mysqli_num_rows($result)>0){
                while($row=mysqli_fetch_array($result)){
                    ?>
                    <div class="product">
                        <form action="kiranaking.php?action=add&id=<?php echo $row["id"]?>" method="post">   
                        <div class="product row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <h3 class="text-secondary"><?php echo $row["availability"];?></h3>
                            ...
                            <input type="hidden" name="hidden_available" value="<?php echo $row["availability"];?>">
